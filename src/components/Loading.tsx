const Loading = () => {
  return (
    <div className="flex h-[85vh] w-full max-w-md items-center justify-center rounded-3xl bg-white shadow-2xl sm:max-w-lg md:max-w-xl lg:max-w-2xl dark:bg-dark-card dark:shadow-none">
