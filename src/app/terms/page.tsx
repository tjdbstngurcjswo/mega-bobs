    ...
    >
      ...
      <section id="service-overview" className={legalSectionClass}>
        ...
        <p className={legalSectionBodyClass}>
          ...
          위해 자발적으로 만든 비공식 사이드 프로젝트입니다. 메가존이 운영하거나
          공식 승인한 서비스가 아닙니다. 날짜별 식단 확인, 코스별 맛 평가 투표,
      ...
      <section id="how-to-use" className={legalSectionClass}>
        ...
        <ul className={legalSectionListClass}>
          <li>
            <b>식단표 조회</b> — 주간 캘린더에서 날짜를 선택해
            코스1·코스2·테이크아웃 메뉴와 칼로리 정보를 확인할 수 있습니다.
          </li>
          <li>
            <b>맛 평가 투표</b> — 각 코스에 대해 평가할 수 있습니다. 하루 코스당
            1회만 투표 가능합니다.
          </li>
          <li>
      ...
      <section id="changes" className={legalSectionClass}>
        ...
        <p className={legalSectionBodyClass}>
          본 서비스는 개인이 자유 시간에 유지·관리하는 비공식 프로젝트로, 예고
          없이 변경되거나 중단될 수 있습니다. 중요한 변경사항은 공지사항
          페이지를 통해 안내하도록 노력합니다.
        </p>
      </section>
      ...
      <section id="disclaimer" className={legalSectionClass}>
        ...
        <p className={legalSectionBodyClass}>
          표시되는 식단 정보는 공식적으로 제공받은 데이터가 아니며 실제 메뉴와
          다를 수 있습니다. 정보의 정확성·완전성을 보장하지 않으며, 이로 인한
          불이익에 대해 제작자는 책임을 지지 않습니다. 시스템 장애·점검 등으로
          인한 서비스 중단에도 동일하게 적용됩니다.
        </p>
      </section>
