...
Phase 1 기획문서를 `mcp__notion-local__API-retrieve-a-page` 로 조회한다.

페이지 ID: `376cb4f8-4b7f-81ba-8a2c-c6c54aa75fd1`

필요 시 `mcp__notion-local__API-get-block-children` 으로 하위 블록까지 읽어 티켓과 관련된 기능 설명·UX 흐름·제약사항을 파악한다.
